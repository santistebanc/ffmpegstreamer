...
def start_live_stream():
    ...
    try:
        ...
        ffmpeg_cmd = [
            ...
            'drawtext=text=\'Server Uptime\':x=10:y=30:fontsize=24:color=white:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf,'
            'drawtext=text=\'%{pts\\:hms}\':x=10:y=60:fontsize=32:color=yellow:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf,'
            'drawtext=text=\'HLS Live Stream\':x=10:y=100:fontsize=20:color=cyan:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf',
            '-c:v', 'libx264',
            '-preset', 'ultrafast',
            '-tune', 'zerolatency',
            '-crf', '23',
